class Exhibition {
    ...
    createHTML(){
        return '<li class="ListItem">' + '<a href="../html/exhibition_subpages/exhibition1.html" style="padding:0">' + '<h2>' + this.name + '</h2>' + '</a>' + '<span class="artType" id="artType1">' + this.artType + '</span>' + '    ' + '<span class="artStyle" id="artStyle1">' + this.artStyle + '</span>' + '<p id="desEx1">' + this.description + '</p>' + '<button class="addPickButton" id="Luca Tombolini Exhibition">' + '+ My Picks' + '</button>' + '<button class="removePickButton" id="Luca Tombolini Exhibition">' + '– My Picks' + '</button>' + '</li>'
    }
